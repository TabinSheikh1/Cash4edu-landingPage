...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* Dark overlay visible only in dark mode */}
      ...
      <div className="relative container z-[3]">
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-6 gap-y-10 items-center">
          <div className="mt-14 lg:mt-0">
            ...
            >
              Cash 4 Edu helps students unlock scholarships, financial
              resources, and rewards — all in one app
            </p>
            <div
              ref={btnsRef}
            ...
            >
              ...
              <Link
                href="#partner"
                className="py-2 px-6 text-[#014bac] dark:text-white rounded-md border border-[#014bac] dark:border-gray-200 text-base hover:border-[#014bac] hover:bg-[#014bac] hover:text-white transition-all duration-500 font-medium"
              >
                Partner with Us
              </Link>
