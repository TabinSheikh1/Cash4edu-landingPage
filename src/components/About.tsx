...
const About = () => {
  ...
  useEffect(() => {
    ...
    if (stepsRef.current) {
      gsap.fromTo(stepsRef.current.children, { opacity: 0, y: 40, scale: 0.96 }, {
        opacity: 1,
        y: 0,
        scale: 1,
        duration: 0.9,
    ...
    if (imgRef.current) {
      gsap.fromTo(imgRef.current, { opacity: 0, x: 60, scale: 0.95, rotate: 6 }, {
        opacity: 1,
        x: 0,
        scale: 1,
        rotate: 0,
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 items-center gap-6">
          <div className="lg:ms-5 ms-8">
            ...
            {/* Steps */}
            <div ref={stepsRef} className="grid lg:grid-cols-3 grid-cols-1 gap-8 mt-9">
              <div>
                <div className="flex items-center justify-start">
                  <div className="items-center justify-center flex bg-green-50 dark:bg-green-900/30 rounded-full h-20 w-20 border border-dashed border-green-50 dark:border-green-800/50">
                    <IconifyIcon icon="lucide:smartphone" className="h-8 w-8 text-black dark:text-white" />
                  </div>
                </div>
                <h1 className="text-xl font-semibold pt-6 text-gray-900 dark:text-white">1. Download</h1>
              ...
              <div>
                <div className="flex items-center justify-start">
                  <div className="items-center justify-center flex bg-red-50 dark:bg-red-900/30 rounded-full h-20 w-20 border border-dashed border-red-50 dark:border-red-800/50">
                    <IconifyIcon icon="lucide:file-text" className="h-8 w-8 text-black dark:text-white" />
                  </div>
                </div>
                <h1 className="text-xl font-semibold pt-6 text-gray-900 dark:text-white">2. Set Profile</h1>
                <p className="text-base text-gray-600 dark:text-gray-400 font-normal mt-2">
              ...
              <div>
                <div className="flex items-center justify-start">
                  <div className="items-center justify-center flex bg-primary/10 dark:bg-blue-900/30 rounded-full h-20 w-20 border border-dashed border-primary/10 dark:border-blue-800/50">
          ...
          <div className="flex items-center relative" ref={imgRef}>
            <Image
              src={study}
              className="lg:h-[500px] lg:w-[500px] md:w-[600px] md:h-[500px] h-[300px] w-[330px] rounded-xl mx-auto drop-shadow-2xl border border-gray-200 dark:border-gray-700"
              alt="study"
              width={538}
              height={200}
            />
