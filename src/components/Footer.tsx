...
function Footer() {
  return (
    <>
      <footer className="bg-gradient-to-br from-[#014bac] to-[#17243A] dark:from-gray-900 dark:to-black">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 py-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-200 dark:text-gray-400 text-md leading-tight mb-6 max-w-md">
              ...
              <div className="space-y-4">
                <a className="flex items-center gap-4 text-gray-200 dark:text-gray-400 hover:text-[#05d3f7] dark:hover:text-[#05d3f7] transition-all duration-300 group" href="mailto:Info@cash4edu.com">
            ...
            {/* Legal */}
            <div className="lg:col-span-1">
              <h4 className="font-bold text-white dark:text-gray-100 text-lg mb-6 pb-2 border-b-2 border-[#05d3f7] inline-block">Legal</h4>
              <div className="space-y-4">
                <p><a className="flex items-center gap-2 text-gray-200 dark:text-gray-400 hover:text-[#05d3f7] dark:hover:text-[#05d3f7] transition-all duration-300" href="#">Terms of Use</a></p>
                <p><a className="flex items-center gap-2 text-gray-200 dark:text-gray-400 hover:text-[#05d3f7] dark:hover:text-[#05d3f7] transition-all duration-300" href="#">Privacy Policy</a></p>
                <p><a className="flex items-center gap-2 text-gray-200 dark:text-gray-400 hover:text-[#05d3f7] dark:hover:text-[#05d3f7] transition-all duration-300" href="#">Cookie Policy</a></p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-[#05d3f7]/20 py-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-3">
                <a className="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg bg-[#014bac] text-white hover:bg-[#05d3f7] dark:hover:bg-[#05d3f7] hover:scale-110 transition-all duration-300 dark:bg-gray-800" href="#">
