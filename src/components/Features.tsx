...
const FeaturesSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -bottom-24 -right-24 w-72 h-72 bg-pink-100 dark:bg-pink-900 rounded-full opacity-30 blur-3xl pointer-events-none"></div>

      <div className="container mx-auto px-4 w-[95%]">
        {/* Section Headline */}
        <h2 className="text-4xl md:text-5xl font-extrabold text-center 
          text-gray-900 dark:text-white mb-4 tracking-tight">
          Everything You Need in{" "}
          <span className="bg-gradient-to-r from-[#014bac] to-[#05d3f7] bg-clip-text text-transparent">
            One App
          </span>
        </h2>
        <p className="text-center text-lg text-gray-700 dark:text-gray-300 mb-14 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div
                className={`absolute -z-10 inset-0 rounded-3xl opacity-0 
              ...
              {/* Icon */}
              <div
                className={`w-20 h-20 flex items-center justify-center rounded-full text-4xl mb-5 
              ...
              {/* Title */}
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2 text-center group-hover:text-[#05d3f7] transition-colors duration-300">
                {feature.title}
              </h3>

              {/* Description */}
              <p className="text-gray-600 dark:text-gray-300 text-base text-center max-w-xs">
                {feature.description}
              </p>
            </div>
          ))}
